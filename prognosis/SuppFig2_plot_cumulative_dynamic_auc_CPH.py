...
for i in range(10):
	with open("./CPH_models/RP_eyesight_loss<0.3_CPH_DaysToOutcome>0_BGalone_rep"+str(i+1)+".sav", 'rb') as f:
...
fig.savefig("RP_eyesight_loss<0.3_CPH_DaysToOutcome>0_BGalone_cumulative_dynamic_auc.pdf")
